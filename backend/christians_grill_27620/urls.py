"""christians_grill_27620 URL Configuration
...
admin.site.site_header = "Christians Grill"
admin.site.site_title = "Christians Grill Admin Portal"
admin.site.index_title = "Christians Grill Admin"

# swagger
api_info = openapi.Info(
    title="Christians Grill API",
    default_version="v1",
    description="API documentation for Christians Grill App",
)
